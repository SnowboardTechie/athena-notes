...
### Changed
- `ship` skill — preamble now states its WIP draft-PR scope and points at `/issue-work` and `/pr-self-review` for end-to-end and standalone review work respectively.
