...
Invoke the `ticket-analyst` agent with the ticket reference and the state-dir path. It writes `context.md` with ticket body, comments, linked refs, inferred open questions.
